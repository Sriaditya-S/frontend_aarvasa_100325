...
import "./loader.css";
function M_rent_commercial_plots(){
    ...
    let filter = async()=>{
        ...
        let op = await fetch('https://backendaarvasa100325.vercel.app//filter_map_rent_commercial_plots',
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
...
export default M_rent_commercial_plots;