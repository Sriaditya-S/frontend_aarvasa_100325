...
import "./loader.css";
function M_sale_commercial_plots(){
        ...
        let op = await fetch('https://backendaarvasa100325.vercel.app//rate_property',
            {
                ...
                body : JSON.stringify({a:iip,rt:rating,c:"sale_commercial_plots_rating"}),
    ...
    let filter = async()=>{
        ...
        let op = await fetch('https://backendaarvasa100325.vercel.app//filter_map_sale_commercial_plots',
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
...
export default M_sale_commercial_plots;