...
function Sale_residential_plots() {
    ...
    let sbmt = async()=>{
        ...
        let abd = {...formData};
        abd.images = images;
        let op = await fetch('https://backendaarvasa100325.vercel.app//post_sale_residential_plots',
            {
                method: 'POST',
                headers: {
    ...
    return (
        <div>
            <h2>SELL YOUR RESIDENTIAL PLOT</h2>
...
export default Sale_residential_plots;
