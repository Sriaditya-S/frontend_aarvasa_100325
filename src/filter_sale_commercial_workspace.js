...
function Sale_commercial_workspace_filter(){
    ...
    useEffect(()=>{
        ...
        async function t(){
            ...
            let op = await fetch('http://localhost:8000/all_commercial_workspace_sale_properties',
                {
                    method: 'POST',
                    headers: {
    ...
    let filter = async() =>{
        ...
        let op = await fetch('http://localhost:8000/filter_commercial_workspace_sale_properties',
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
