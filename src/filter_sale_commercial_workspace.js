...
function Sale_commercial_workspace_filter(){
    ...
    useEffect(()=>{
        ...
        async function t(){
            ...
            let op = await fetch('https://backendaarvasa100325.vercel.app/all_commercial_workspace_sale_properties',
                {
                    method: 'POST',
                    headers: {
        ...
        let op = await fetch('https://backendaarvasa100325.vercel.app/rate_property',
            {
                ...
                body : JSON.stringify({a:iip,rt:rating,c:"sale_commercial_workspace_rating"}),
    ...
    let filter = async() =>{
        ...
        let op = await fetch('https://backendaarvasa100325.vercel.app/filter_commercial_workspace_sale_properties',
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
